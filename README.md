...
None of the case studies are hypothetical. Reconciliation, control evidence, exception handling, period-over-period checks — I've handled versions of all of it across my previous companies. I'm keeping the employer and process details out of this repo on purpose; that's not mine to publish. But if you want to hear the real version behind any of these, ask me in an interview.
