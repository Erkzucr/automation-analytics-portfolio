...
| CTL-09 | Only policy rates are applied | No policy for a category means an exception, not a default | exception_records.csv NO_POLICY_FOR_CATEGORY, accepted_records.csv policy_rate |
